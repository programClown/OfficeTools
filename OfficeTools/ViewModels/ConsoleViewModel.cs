...
public partial class ConsoleViewModel : ObservableObject, IDisposable, IAsyncDisposable
{
    ...
    /// </summary>
    readonly private AsyncLock writeCursorLock = new();
    ...
    private async Task ConsoleUpdateLoop()
    {
        ...
        CancellationToken ct = updateCts?.Token
    ...
    private void ConsoleUpdateOne(ProcessOutput output)
    {
        ...
        if (output.ApcMessage is not null)
        {
            ...
            ApcMessage message = output.ApcMessage.Value;
        ...
        {
            DocumentLine? currentLine = Document.GetLineByOffset(writeCursor);
        ...
        if (output.CursorUp > 0)
        {
            ...
            TextLocation currentLocation = Document.GetLocation(writeCursor);
    ...
    private void DebugPrintDocument()
    {
        ...
        DocumentLine? cursorLine = Document.GetLineByOffset(writeCursor);
