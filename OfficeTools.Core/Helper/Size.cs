...
public static class Size
{
    ...
    private static string TrimZero(string value) => value.TrimEnd('0').TrimEnd('.');
    ...
    public static string FormatBase10Bytes(long bytes) => FormatBase10Bytes(Convert.ToUInt64(bytes));
}